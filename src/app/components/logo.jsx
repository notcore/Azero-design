...
function Logo() {
  return (
    <motion.div
      ...
      className="sm:flex opacity-[70%] md:gap-8 grid grid-cols-2 justify-center sm:gap-6 items-center gap-4 mx-12 md:my-8 my-12 flex-wrap"
    >
      {[
        ...
        <div key={i} className="flex items-center justify-center gap-4 my-3">
